...
<title>APID | Contribute API</title>
<!-- plugins:css -->
<link rel="stylesheet"
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header"
									...
									<h3 class="m-0 text-white">Contribute API</h3>
								</div>
								<div class="card-body">
									<f:form class="cmxform" method="get" action="contributeApi" modelAttribute="contributeApiVO">
										<f:hidden path="apiId" />
										<div class="row">
											...
											<f:hidden path="contributor"/>
										</div>
										<input class="btn btn-primary" type="submit" value="Request Contribution">
									</f:form>
								</div>
							</div>
						</div>
